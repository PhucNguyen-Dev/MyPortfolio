...
const Education = () => {
  return (
    <motion.div
      ...
      className="py-12 font-titleFont flex w-full  flex-col lgl:flex-row gap-10 lgl:gap-20 "
    >
      {/* part one */}
      <div>
        ...
        <div className="mt-6 lgl:mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          ...
          />
          <ResumeCard
            title="Software Developer Major"
      ...
      <div>
        ...
        <div className="mt-6 lgl:mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          ...
          <ResumeCard
            ...
            result="Home"
            des="Who would know the Covid Epidemic has begun to rampage the world. Because of the social distancing, I have to find another way to learn and gain experience. 
