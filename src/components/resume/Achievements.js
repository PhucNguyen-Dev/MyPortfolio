      ...
      <div>
        ...
        <div className="mt-6 lgl:mt-14 h-1/2 hover:h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            ...
            result="Failed"
            des="Used to be a member of the Physics team and competed in 
            Dong Nai province but only stopped at the consolation prize."
          />
          <ResumeCard
            title="Academic Contests."
            subTitle="Water rocket building contest."
            result="Won the first prize"
            des="We built our rocket toys with only PVC pipes, 502 adhesive 
            with pure water and use `water-pressure` to propel the rocket as high as possible"
          />
          <ResumeCard
            title="Academic Contests."
